...
-- Storage policies for deal-images bucket (DROP first — safe to re-run on existing projects)
...
-- Members cannot self-approve; only admins change approved on update
